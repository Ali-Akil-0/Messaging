...
const Auth = () => {
    ...
    const handleChange =(e)=>{
        // setting the information into a form which is an object
            ...
            <form onSubmit={handleSubmit} >
                {isSignup &&(
                 ...
                 <div className='auth__form-container_fields-content_input'>
                    ...
                    <input name='password' type="password" autoComplete="on" placeholder='Password' onChange={handleChange}  required />
                    </div>
                    {isSignup &&(
                    <div className='auth__form-container_fields-content_input'>
                    ...
                    <input name='confirmPassword' type="password" autoComplete="on" placeholder='Confirm Password' onChange={handleChange}  required />
                    </div>
                )}
